...
def des_encode(data, firstKey):
    des_js = execjs.compile(js)
    encoded_string = des_js.call("strEnc", data, firstKey)
    return encoded_string

# 测试
if __name__ == '__main__':
    data = "227421"
    # firstKey = 'wap_accnbr_2016'
    firstKey = 'wap_password_2016'
    # password = "762703"
    print(des_encode(data, firstKey))
    print('0DDEDBE99D0CEA35FF899A2DE09383BD')