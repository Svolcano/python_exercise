...
def uifDecode(data):
    ctx = execjs.compile(ur"""function uifEncode(data){
...
function test() {
 ...
 alert("decmsg="+decmsg);  
    ...
    """)
    return ctx.call('uifDecode',data)
if __name__ == '__main__':
    print uifDecode('B3914EAC037D9848')
    print type(uifDecode('B3914EAC037D9848'))
    print type(uifDecode('B3914EAC037D9848').encode('utf-8'))