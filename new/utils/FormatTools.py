...
def format_telnum_BQC(tel):
    ...
    if re.match('^\d{0,4}(4|8)00\d{7}$', tel_num) != None: # 判定为400或800电话
        ...
        if areacode:
            ...
            t_code = tel_num[:lc]
            num = 0
            if t_code in AREACODE_7:
                num = 7
            elif t_code in AREACODE_8:
                num = 8
            if num != 0:
                length = lc + num
...
def aa_format_telnum_BQC():
    assert format_telnum_BQC('40088()_=sad-10115') == '4008810115'
    assert format_telnum_BQC('010-40088-10115') == '4008810115'
    assert format_telnum_BQC('031540088-10115') == '4008810115'
    assert format_telnum_BQC('003-51252492-8') == '0351-2524928'
    assert format_telnum_BQC('075-52503013-6') == '0755-25030136'
    assert format_telnum_BQC('134-77261944-') == '13477261944'
    assert format_telnum_BQC('+86134-77261944-') == '13477261944'
    assert format_telnum_BQC('0+86134-77261944-') == '13477261944'
    assert format_telnum_BQC('086134-77261944-') == '13477261944'
    assert format_telnum_BQC('0086134-77261944-') == '13477261944'
    assert format_telnum_BQC('086134-77261944-') == '13477261944'
    return


if __name__ == "__main__":
    tel = '4000271262*81106'
    a = format_telnum_BQC(tel)
    print(a)
